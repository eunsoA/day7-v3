...
export const mockUser: User = {
  ...
  currentChallenges: ['challenge3', 'challenge10', 'challenge11'],
...
export const additionalUsers: User[] = [
  ...
  },
  {
    ...
    currentChallenges: ['challenge3', 'challenge11'],
...
export const mockChallenges: Challenge[] = [
  ...
  },
  {
    id: 'challenge11',
    title: '아침 스트레칭 루틴',
    description: '매일 아침 전신 스트레칭으로 몸과 마음 깨우기!',
    status: 'in-progress',
...
export const mockVerifications: DailyVerification[] = [
  ...
  // 1일차 인증 기록
  {
    ...
    day: 1,
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=400&h=300&fit=crop',
  ...
  // 1일차 인증 기록
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=400&h=300&fit=crop',
    message: '아침 첫 스트레칭! 몸이 깨어나는 느낌이 좋아요.',
    verifiedBy: ['user3', 'user5'],
    createdAt: '2024-06-29T07:00:00Z',
  },
  {
    userId: 'user3',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1506629905607-24d3b3e3da82?w=400&h=300&fit=crop',
    message: '아침 햇살과 함께하는 스트레칭 타임! 하루가 활기차게 시작돼요.',
    verifiedBy: ['user1', 'user5'],
    createdAt: '2024-06-29T07:30:00Z',
  },
  {
    userId: 'user5',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    message: '새벽 공기를 마시며 전신 스트레칭. 자연과 함께하는 시간!',
  ...
  // 2일차 인증 기록
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=400&h=300&fit=crop',
    message: '어제보다 더 유연해진 것 같아요. 스트레칭의 힘!',
    verifiedBy: ['user3', 'user5'],
    createdAt: '2024-06-30T07:15:00Z',
  },
  {
    userId: 'user3',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1506629905607-24d3b3e3da82?w=400&h=300&fit=crop',
    message: '목과 어깨 스트레칭에 집중했어요. 컴퓨터 작업 전 필수!',
    verifiedBy: ['user1', 'user5'],
    createdAt: '2024-06-30T07:45:00Z',
  },
  {
    userId: 'user5',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    message: '요가 매트 위에서 심호흡과 함께. 마음도 함께 스트레칭!',
    verifiedBy: ['user1', 'user3'],
  ...
  // 3일차 인증 기록
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=400&h=300&fit=crop',
    message: '비 오는 아침에도 실내에서 스트레칭! 날씨에 상관없이 꾸준히.',
    verifiedBy: ['user3', 'user5'],
  ...
  },
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1506629905607-24d3b3e3da82?w=400&h=300&fit=crop',
    message: '스트레칭 루틴이 이제 자연스러워졌어요. 습관의 힘!',
    verifiedBy: ['user1', 'user5'],
  ...
  },
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    message: '아침 스트레칭으로 몸의 긴장을 풀어줘요. 하루 종일 컨디션 좋아요!',
    verifiedBy: ['user1', 'user3'],
  ...
  // 4일차 인증 기록
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=400&h=300&fit=crop',
    message: '다리 스트레칭에 집중한 하루. 허벅지와 종아리가 시원해요!',
    verifiedBy: ['user3', 'user5'],
    createdAt: '2024-07-02T07:10:00Z',
  },
  {
    userId: 'user3',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1506629905607-24d3b3e3da82?w=400&h=300&fit=crop',
    message: '팔과 손목 스트레칭으로 시작! 오늘도 활기찬 하루 되세요.',
    verifiedBy: ['user1', 'user5'],
    createdAt: '2024-07-02T07:35:00Z',
  },
  {
    userId: 'user5',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    message: '전신 스트레칭으로 몸의 균형을 맞춰줘요. 몸이 가벼워지는 느낌!',
    verifiedBy: ['user1', 'user3'],
  ...
  // 5일차 인증 기록
  {
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1588286840104-8957b019727f?w=400&h=300&fit=crop',
    message: '5일째 아침 스트레칭! 이제 정말 습관이 된 것 같아요.',
    verifiedBy: ['user3', 'user5'],
    createdAt: '2024-07-03T07:05:00Z',
  },
  {
    userId: 'user3',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1506629905607-24d3b3e3da82?w=400&h=300&fit=crop',
    message: '척추 스트레칭에 집중했어요. 자세가 좋아지는 느낌!',
    verifiedBy: ['user1', 'user5'],
    createdAt: '2024-07-03T07:25:00Z',
  },
  {
    userId: 'user5',
    challengeId: 'challenge11',
    ...
    status: 'completed',
    photo: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop',
    message: '아침 스트레칭이 하루의 시작 의식이 되었어요. 감사한 마음으로!',
    verifiedBy: ['user1', 'user3'],
